...
from BERT_BiLSTM_CRF import MyExample, Model, SLUDataSet, convert_ids_to_words, remove_pad, tokenizer
import json
############
# 初始化参数 #
############
...
with open('output/test/BERT_BiLSTM_CRF.json', 'w', encoding="utf8") as f:
